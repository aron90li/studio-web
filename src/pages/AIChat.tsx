...
const injectKeyframes = () => {
  ...
  s.textContent = [
    ...
    '.md-content code{background:rgba(77,107,254,.08);color:#4d6bfe;padding:2px 6px;border-radius:4px;font-size:13px;font-family:Consolas,\'Courier New\',monospace}',
    '.md-content pre{background:#f5f5f5;color:#1d2129; border:1px solid #e8e8ea;padding:14px 16px;border-radius:10px;overflow-x:auto;margin:8px 0;font-size:13px;line-height:1.6;font-family:Consolas,\'Courier New\',monospace}',
